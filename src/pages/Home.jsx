  ...
  return (
    <div
      className="
        px-4 py-4
        sm:px-6
        md:pl-24 md:pr-6 md:py-6
        max-w-[1400px]
        space-y-8 md:space-y-12
      "
    >
      <TopicRow title="Trending" Icon={Flame} movies={movies} count={10} />
      <TopicRow title="Ranking" Icon={Crown} movies={movies} count={10} />
      <TopicRow title="Favorites" Icon={Heart} movies={movies} count={10} />
    </div>
  )
}
